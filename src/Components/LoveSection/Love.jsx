        ...
        <div className='my-10 container mx-auto'>
            ...
            <div className='grid grid-cols-1 mx-3 md:grid-cols-3 gap-4 md:gap-8'>
                <div className='relative'>
                    <img className='mx-auto' src="/public/ingredients (1).jpg" alt="ingredients image" />
                ...
                <div className='relative'>
                    <img className='bg-gray-200 px-4 mx-auto' src="/public/chef.png" alt="chef image" />
                    <div className='bg-gray-50 text-center absolute bottom-0 p-5 md:p-8 opacity-75 md:opacity-0 md:hover:opacity-75'>
                ...
                <div className='relative'>
                    <img className='bg-gray-200 mx-auto' src="/public/delivery.jpg" alt="delivery image" />
                    <div className='bg-gray-50 text-center absolute bottom-0 p-5 md:p-8 opacity-75 md:opacity-0 md:hover:opacity-75'>

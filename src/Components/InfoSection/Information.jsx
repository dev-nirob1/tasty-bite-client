        ...
        <div className='container mx-auto my-10  bg-gray-50'>
            ...
            <div className='flex flex-col md:flex-row items-center mx-3 md:mx-0 gap-8 rounded-mdpy-8 md:py-10'>
                ...
                <div className='w-full md:w-1/2 p-5'>
                    ...
                    <div className='flex items-center gap-2 mb-2'>
                        <h4 className='text-lg font-medium text-gray-800 flex items-center gap-1'><FaEnvelope className='text-orange-500' /><span>Email:</span></h4>
                        <p className='font-medium text-gray-600'>example.res@gmail.com</p>
                    </div>
                    <div className='flex items-center gap-2 mb-2'>
